...
`P01` remains the complete reference implementation. `P02` through `P11` are implemented governed
modules; `P12`–`P24` remain intentional scaffolds so each can be implemented in a bounded,
reviewable batch.
