# P16 checks: Enter Graceful Degradation and Safe State
...
- the learner can answer: “What inputs, observable effects, and failure modes matter when you enter Graceful Degradation and Safe State?” without relying on MATLAB syntax.
